...
<link href="<?php echo css_url('default')?>" rel="stylesheet" type="text/css" media="all" />
<link href="<?php echo css_url('fonts')?>" rel="stylesheet" type="text/css" media="all" />
...
<div id="banner">
	<div class="container">
		<!--<ul class="staff">
			<li><img src="<?php echo img_url('pic01.jpg')?>" alt="" /></li>
			<li><img src="<?php echo img_url('pic02.jpg')?>" alt="" /></li>
			<li><img src="<?php echo img_url('pic03.jpg')?>" alt="" /></li>
		</ul>-->
		<div class="title">
